                    ...
                    >
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    placeholder="15"
                                                    className={getInputClass("reorderLevel")}
                                                />
                                            </div>
                                            {errors.reorderLevel && (
                                                <p className="text-xs text-red-500 font-medium pr-1 flex items-center gap-1">
                                                    <span>⚠</span> {errors.reorderLevel}
                                                </p>
                                            )}
                                        </div>
                        ...
                        <div className="px-6 py-5 bg-gray-50/80 border-t border-(--color-border) flex items-center justify-end gap-3 backdrop-blur-sm">
                            ...
                            <button
                                ...
                                className="px-10 py-2.5 rounded-xl text-sm font-bold text-white bg-(--color-primary) hover:bg-(--color-primary-dark) shadow-lg shadow-teal-500/20 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100 cursor-pointer min-w-[140px]"
                            >
                                {isSubmitting ? (
